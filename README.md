...
Institutional LR=1e-4 experiment

Kaggle notebook

Institutional full training

Kaggle notebook

ViT-B/32 recovery evaluation
...
SmallCNN institutional evaluation

Kaggle notebook

Results analysis / ROC

Kaggle notebook

RQ3 combined datasets

Kaggle notebook

RQ2 ResNet-18 evaluation

Kaggle notebook

Cross-dataset skilled-threshold evaluation
...
not publicly redistributable. See the project dataset documentation for
